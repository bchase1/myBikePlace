...
<head>
    ...
    <title>myBikePlace - Delete Bike Ride</title>
</head>
<body class="container #18ffff #9fa8da indigo lighten-3 ">
<div class="container">
    <br><br>
    <h1 class="header center #000000 black-text text-lighten-2">myBikePlace - Delete Bike Ride</h1>
    <div class="row center"></div>
</div>
<div id="content">
    <form action="deleteUserBikeRide" method="POST">

        Id: <input type = "text" name = "id"
                   data-error="Please enter the bike rides id." required>
        <br />
        <button type="SUBMIT" class="btn btn-default col-sm-offset-3"
                data-disable="true">Delete The Bike Ride
        </button>
